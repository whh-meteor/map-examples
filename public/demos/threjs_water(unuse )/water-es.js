...
class Water extends THREE.Mesh {
	constructor(geometry, options) {
		...
		this.onBeforeRender = function (renderer, scene, camera) {
			// 添加安全检查，确保所有对象都存在
			if (!this || !this.matrixWorld || !camera || !camera.matrixWorld) {
				return;
			}
			...
			// Paper explaining this technique: http://www.terathon.com/lengyel-Oblique.pdf
			...
			// 兼容新版本Three.js，使用xr替代vr
			var currentXrEnabled = (renderer.xr && renderer.xr.enabled) ? renderer.xr.enabled : false;
...
// Export the class for use in Vue components
THREE.Water = Water;
export { Water };